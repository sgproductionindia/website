...
/* ════════════════════════════════════════════
  ...
  *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
  ...
  .date-chip.active, .date-chip:hover { background:var(--tint); color:#fff; }
  ...
  .chart-summary { display:flex; align-items:center; justify-content:space-between; gap:var(--sp-3); margin-bottom:var(--sp-3); color:var(--label-secondary); font-size:12px; font-weight:600; }
  .chart-summary strong { color:var(--label); font-size:15px; }
  .line-chart-shell svg { width:100%; height:100%; display:block; }
  .line-chart-shell svg line, .line-chart-shell svg polyline { vector-effect:non-scaling-stroke; }
  ...
  .chart-toggle {
    display:flex; gap:var(--sp-1); padding:3px;
    border:1px solid var(--separator); border-radius:var(--radius-pill); background:var(--bg-tertiary);
  }
  .chart-toggle button {
    border:0; border-radius:var(--radius-pill); background:transparent;
    color:var(--label-secondary); padding:var(--sp-1) var(--sp-3);
    font:inherit; font-size:12px; font-weight:600; cursor:pointer;
    min-height:28px;
    transition:background var(--duration) var(--ease-out), color var(--duration) var(--ease-out);
  }
  .chart-toggle button.active, .chart-toggle button:hover { background:var(--tint-bg); color:var(--tint); }
    ...
    <?php else: ?>
      <aside class="sidebar">
        ...
        <nav>
          ...
          <div class="nav-section"><div class="nav-label">Monetization</div><a class="nav-item" href="#advertising" data-section="advertising"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M19 10.5V6a1 1 0 0 0-1.447-.894L5 11H3a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h2l3.5 1.75M19 10.5V15M19 10.5l2-1.5M19 15l2 1.5M7.5 15.75V19a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-3"/></svg>Advertising</a></div>
